...
/// <summary>
/// Remember to change to Namespace to your current project
/// </summary>
namespace Laurids_Vestergaard.Factories
{
    /// <summary>
    ...
    public abstract class AutoFactory<T>
    {
        ...
        public AutoFactory()
        {
            ...
            connectionString = ConfigurationManager.ConnectionStrings["DCMS_ConnectionString"].ConnectionString;
        }
